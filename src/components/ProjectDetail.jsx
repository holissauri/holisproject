...
const handleLiveDemoClick = (liveDemoLink) => {
  if (!liveDemoLink) {
    Swal.fire({
      ...
      text: "Live demo is not available for this project yet.",
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/holissauri",
      ...
      <div className="min-h-screen bg-[#030014] flex items-center justify-center px-6">
        <div className="text-center space-y-6 max-w-lg">
          ...
          <p className="text-gray-400">
            The project detail is not available yet. Please return to the portfolio page.
          </p>
          <button
            onClick={() => navigate("/")}
            className="inline-flex items-center px-5 py-2.5 rounded-lg bg-white/10 text-white hover:bg-white/15 transition-colors"
          >
            Back to Home
          </button>
        </div>
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                <a
                  ...
                  onClick={(e) => !handleLiveDemoClick(project.Link) && e.preventDefault()}
