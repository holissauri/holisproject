...
const WORDS = ["AI Engineer", "Machine Learning Engineer", "LLM Developer"];
const TECH_STACK = ["Python", "PyTorch", "TensorFlow", "FastAPI", "LangChain", "Docker"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/holissauri" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/holis-sindy-sauri-b7a7ab386/" },
  { icon: Instagram, link: "https://www.instagram.com/holis.to.omotta/" },
];
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  I build end-to-end AI solutions, from data
                  preprocessing and model training to scalable API
                  deployment for real-world business impact.
                </p>
